        ...
        <div class="container-fluid py-5">
            <div class="row px-xl-5">
                <div class="col-lg-5 pb-5">
                    <div>
                        <img class="w-100 h-100" src="<?php echo $item['ProdImageLink']?>" alt="Image">   
                    </div>
                </div>
                ...
                <div class="col-lg-7 pb-5">
                    ...
                    <h3 class="font-weight-semi-bold mb-4"> $<?php echo $item['ProdPrice']?></h3>
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        <div class="input-group quantity mr-3" style="width: 130px;">
                                ...
                                <input type="text"  class="form-control bg-secondary text-center" name="amount" value="1">
                                <div class="input-group-btn">
                                    <button 
